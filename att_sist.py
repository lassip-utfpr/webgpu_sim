...
sinal_emitido = result_real2[:701,4]
sinal_recebido = result_real2[3000:3701,4]
...
axes[1].set_title('Resposta Impulsiva h(t) - H(f)=Y(f)/X(f) com filtro')
...
#np.save('./H_filtered.npy',H_filtered)
#np.save('./h.npy', h)
