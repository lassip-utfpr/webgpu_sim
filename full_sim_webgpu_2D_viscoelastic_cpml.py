...
if do_sim_gpu:
    for n in range(n_iter_gpu):
        ...
        for law in range(n_laws):
            ...
            name = (f'ensaios/teste_viscoelastico/results/result_2D_viscoelast_CPML_{now.strftime("%Y%m%d-%H%M%S")}_'
            ...
            if save_bscan:
                name = f'ensaios/teste_viscoelastico/results/bscan_2D_viscoelast_CPML_{datetime.now().strftime("%Y%m%d-%H%M%S")}_law_{law}'
...
if do_sim_cpu:
    for n in range(n_iter_cpu):
        ...
        for law in range(n_laws):
            ...
            if save_bscan:
                name = f'ensaios/teste_viscoelastico/results/bscan_2D_viscoelast_CPML_{datetime.now().strftime("%Y%m%d-%H%M%S")}_law{law}'
