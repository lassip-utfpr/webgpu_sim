...
from PyQt6.QtCore import QTimer, QObject, QRunnable, QThreadPool, pyqtSignal, pyqtSlot
...
def sim_webgpu(device):
    ...
    with open('shader_2D_acoustic_cpml_wgpu.wgsl') as shader_file:
    ...
    def sim_loop(progress_callback):
        global it
        while it <= NSTEP:
            up_sim()
    ...
    # Inicia o thread pool e o Worker
    threadpool = QThreadPool()
    worker = Worker(sim_loop)
